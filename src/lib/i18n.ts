...
export const i18n = {
  de: {
    ...
    tokInput: "Input",
    tokOutput: "Output",
    tokOutputIncl: "Output (inkl. Reasoning)",
    ...
    chartTokenShareDay: "Token-Anteile",
    modeVolume: "Volumen",
    modeCost: "Kosten",
    cardTotal: "Gesamt",
    ...
    globalProjectFilter: "Projekt-Filter",
    globalProjectAll: "Alle Projekte",
    globalActiveOn: "Filter aktiv auf allen Seiten",
    dayDetailTitle: "Statistik für {date}",
    dayDetailClose: "Schließen",
    dayDetailByModel: "Top-Modelle an diesem Tag",
    dayDetailByProject: "Projekte an diesem Tag",
    dayDetailSessions: "Aktive Sessions ({count})",
    dayDetailEmpty: "Keine Aktivität an diesem Tag.",
    projectsShowSessions: "Sessions anzeigen",
    ...
    // --- Share dialog ---
    shareButton: "Teilen",
    shareTitle: "Statistik teilen",
    shareToday: "Heute",
    shareYesterday: "Gestern",
    shareWeek: "Diese Woche",
    shareLastWeek: "Letzte Woche",
    shareMonth: "Dieser Monat",
    shareLastMonth: "Letzter Monat",
    shareProjAll: "Alle",
    shareProjHide: "Namen verbergen",
    shareProjNone: "Ohne",
    shareProjectsLabel: "Projekte",
    shareImageLang: "Bildsprache",
    shareDownload: "PNG herunterladen",
    shareCopy: "PNG kopieren",
    shareCopied: "Kopiert!",
    shareOpenSvg: "SVG öffnen",
    shareAltText: "Statistik-Karte: Token-Verbrauch ({range})",
    shareClose: "Schließen",
    rangeChip: "Zeitraum: {label}",
    rangeClear: "Zurücksetzen",
    periodDetailTitle: "Details: {label}",
    periodDetailEmpty: "Keine Aktivität in diesem Zeitraum.",
    periodByModel: "Top-Modelle",
    periodByProject: "Projekte",
    periodSessions: "Sessions ({count})",
    periodHourChart: "Nachrichten pro Stunde",
    periodDayChart: "Nachrichten pro Tag",
  },
  en: {
    // --- App / brand ---
    appTitle: "opencode-usage",
    ...
    tokInput: "Input",
    tokOutput: "Output",
    tokOutputIncl: "Output (incl. reasoning)",
    tokReasoning: "Reasoning",
    tokCacheRead: "Cache read",
    ...
    chartTokenShareDay: "Token share",
    modeVolume: "Volume",
    modeCost: "Cost",
    cardTotal: "Total",
    ...
    globalProjectFilter: "Project filter",
    globalProjectAll: "All projects",
    globalActiveOn: "Filter active on all pages",
    dayDetailTitle: "Statistics for {date}",
    dayDetailClose: "Close",
    dayDetailByModel: "Top models that day",
    dayDetailByProject: "Projects that day",
    dayDetailSessions: "Active sessions ({count})",
    dayDetailEmpty: "No activity on this day.",
    projectsShowSessions: "Show sessions",
    ...
    shareToday: "Today",
    shareYesterday: "Yesterday",
    shareWeek: "This week",
    shareLastWeek: "Last week",
    shareMonth: "This month",
    shareLastMonth: "Last month",
    shareProjAll: "All",
    shareProjHide: "Hide names",
    shareProjNone: "Exclude",
    shareProjectsLabel: "Projects",
    shareImageLang: "Image language",
    shareDownload: "Download PNG",
    shareCopy: "Copy PNG",
    shareCopied: "Copied!",
    shareOpenSvg: "Open SVG",
    shareAltText: "Statistics card: token usage ({range})",
    shareClose: "Close",
    rangeChip: "Period: {label}",
    rangeClear: "Reset",
    periodDetailTitle: "Details: {label}",
    periodDetailEmpty: "No activity in this period.",
    periodByModel: "Top models",
    periodByProject: "Projects",
    periodSessions: "Sessions ({count})",
    periodHourChart: "Messages per hour",
    periodDayChart: "Messages per day",
  },
} as const;
